...
async def on_message(message):
    ...
    if message.content.startswith(".weather"):
        ...
        subprocess.check_output(['cmd', '/c', r'C:\Users\YOUR-USERNAME-HERE\Desktop\getwttr.bat'])
        time.sleep(2)
        channel = message.channel
        
        # Read the weather data from the text file
        with open(r'C:\Users\YOUR-USERNAME-HERE\Desktop\weather.txt', 'r') as file:
            await channel.send(file.read())

###########################################################################
# Load the Discord bot token from a file
token = ""
with open(r"C:\Users\YOUR-USERNAME-HERE\Desktop\tok.en", 'r') as file:
